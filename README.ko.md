...
- planning, systematic debugging, verification, review를 위한 Superpowers-style workflow 명령.
...
기본 prompt는 intent before action, guessing보다 systematic debugging, 변경 명령보다 read-only diagnostic, 완료 주장보다 evidence를 우선합니다.
